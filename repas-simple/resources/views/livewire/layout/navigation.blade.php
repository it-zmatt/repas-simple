        ...
        <div class="flex justify-between h-16" >
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('display') }}" wire:navigate>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('display')" :active="request()->routeIs('display')" wire:navigate style="color: #866556;">
                        {{ __('Feed') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate style="color: #866556;">
                        {{ __('Profile') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('favoris')" :active="request()->routeIs('favoris')" wire:navigate style="color: #866556;">
                        {{ __('Favoris') }}
                    </x-nav-link>
                </div>
            </div>
