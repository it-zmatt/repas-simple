<div>
        ...
        <div>
            ...
            <div class="mt-2 flex justify-center rounded-sm border border-dashed border-gray-200/25 px-6 py-10">

                <div class="text-center">

                    <svg class="mx-auto h-12 w-12 text-gray-200" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div>
            <div>
                ...
                <input type="text" value=" {{$post->title}}" name="text" id="text" autocomplete="Recipe Name" class="bg-gray-800 text-gray-200 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-100 focus:ring-2 focus:ring-inset focus:ring-indigo-200 sm:text-sm sm:leading-6" wire:model="title">
            </div>
        ...
        <div>
            <div class="flex">
                <button wire:click="save()" class=" mr-1 my-5 w-full justify-center rounded-sm bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ">
                    Save
                </button>
